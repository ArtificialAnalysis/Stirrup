...
class Agent[FinishParams: BaseModel, FinishMeta]:
    ...
    def __init__(
        ...
        *,
        ...
        allow_successive_assistant_messages: bool = False,
        # Subagent options
        ...
        Args:
            ...
            allow_successive_assistant_messages: If False (default), automatically inject a continue
        ...
        self._allow_successive_assistant_messages = allow_successive_assistant_messages
