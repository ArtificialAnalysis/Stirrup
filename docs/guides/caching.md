...
- Cache writes are not transactional. Concurrent runs of the same prompt share one
  cache entry and the last writer wins; give them distinct prompts if that matters.
